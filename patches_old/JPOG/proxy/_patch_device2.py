"""
Phase 1: Replace draw_terrain_with_world_dp and add SLOT_GetTransform.
Phase 2: Replace draw_terrain_with_world_dip.
"""
import os, sys

FPATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'd3d9_device.c')
...
print('Done! d3d9_device.c fully patched.')
